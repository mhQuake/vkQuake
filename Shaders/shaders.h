...
extern unsigned char particle_vert_spv[];
extern int particle_vert_spv_size;
extern unsigned char particle_frag_spv[];
extern int particle_frag_spv_size;
...
extern unsigned char sky_box_vert_spv[];
extern int sky_box_vert_spv_size;
